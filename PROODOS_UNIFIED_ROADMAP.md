...
**Candidate addition (logged 2026-05-20, από το Phase F kickoff).** Image-based retrospective reflection — ο εκπαιδευτικός ανεβάζει classroom artefacts (lesson plans, student work, φωτογραφίες) και τα σχολιάζει, με Gemini multimodal ανάλυση. Αφαιρέθηκε από το Phase F γιατί το TAB5 reflection είναι προοπτικό· στο Epilogue ο αναστοχασμός είναι αναδρομικός και το τεκμήριο πια υπάρχει, οπότε εδώ έχει φυσικό σπίτι. Όχι commitment — να αξιολογηθεί όταν σχεδιαστεί το Phase G, αφού ολοκληρωθεί το F.1.
