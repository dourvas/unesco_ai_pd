...
| State | TDs |
|---|---|
| **Resolved** | TD-008 (consent revoke clear ack), TD-012 (sequential gate), TD-013 (Epilogue M15 gate), TD-017 (machine-readable markers — closed in C.3), TD-005 (cp1253 encoding — closed in Phase E commit 1.5 via `manage.py` UTF-8 stdio guard, 2026-05-13), TD-019 (peer synthesis dispute UX — redefined as a usefulness signal and resolved, 2026-05-19), **TD-016 (7-year ConsentRecord retention — closed Phase H.8, 2026-05-25)**, **TD-021 (teacher dashboard duplicates Modules menu — closed Phase H.7, 2026-05-25)**, **TD-026 (Certificate copy + programme duration — closed via TD-027+TD-028 aggregate, 2026-05-27)**, **TD-027 (programme duration methodology — resolved 2026-05-26 with `PROODOS_PROGRAMME_DURATION_METHODOLOGY_v1.2`)**, **TD-028 (TAB1 audit — closed 2026-05-27 with uniform 5h/module + 8-module content corrections + M11 LO addition)** |
| **Active deferred to post-pilot Phase G/H or beyond** | TD-001, TD-002, TD-003, TD-004, TD-009, TD-010, TD-011, TD-014, TD-015, TD-018 (per-artefact dispute deep-links), TD-020 (post-hoc career-stage exploratory analysis — 2026-05-13), **TD-029 (TAB1 LO + overview voice/length consistency pass — 2026-05-27)**, **TD-030 (TAB1 collapsible UNESCO indicators box — 2026-05-27)** |
