...
urlpatterns = [
    ...
    # revoke_followup_recruitment route was rolled back. Follow-up
    # email-retention permission now bundles into the
    # research_participation consent V2; revoke_research_view is the
