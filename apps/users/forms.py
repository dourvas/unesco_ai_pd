...
class GoalsPreferencesForm(forms.ModelForm):
    ...
    # consent_followup_recruitment BooleanField was rolled back. The
    # follow-up email-retention permission bundles into the
    # research_participation V2 consent text (one bullet under
    # "What participation involves:"). Single broad consent, no extra
    # checkbox.
