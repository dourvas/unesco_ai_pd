"""
M13 RAG Ingest Script
====================
Module: Multimodal AI Content Creation
UNESCO Aspect 3: AI Foundations | Level: Create

Ingests:
  1. M13 Main Content (Universal) from modules_modulecontent
  2. M13 Subject-Specific Examples (subject_box_part2 + subject_box_part4)

Run from project root:
    python ingest_m13_rag.py

Prerequisites:
    - .env with GEMINI_API_KEY
    - M13 module record exists in modules_module
    - M13 main_content + subject_box records exist in modules_modulecontent
    - documents + document_chunks tables exist (same schema as M1/M2/M3/M6/M7/M8/M12)
"""
...
# ======================================================================
# HELPERS — identical to M8 ingest
# ======================================================================
...
# ======================================================================
# M13-SPECIFIC PROCESSING FUNCTIONS
# ======================================================================
...
def main():
    print("\n" + "="*70)
    print("M13 RAG INGEST — Multimodal AI Content Creation")
    print("="*70)
    ...
    try:
        ...
        row = cursor.fetchone()
        if not row:
            print("ERROR: M13 module record not found in modules_module!")
            conn.close()
            return
        ...
        print("M13 content in modules_modulecontent:")
        ...
        if process_module_content(
            conn,
            'M13',
            'M13: Multimodal AI Content Creation - Main Content'
        ):
            success_count += 1
        ...
        if process_module_subject_examples(
            conn,
            'M13',
            'M13: Multimodal AI Content Creation - Subject Examples'
        ):
            success_count += 1
