"""
M3 RAG Ingest Script
====================
Module: AI Tools for Educators: Understand, Evaluate & Curate
UNESCO Aspect 3: AI Foundations | Level: Acquire

Ingests:
  1. M3 Main Content (Universal) from modules_modulecontent
  2. M3 Subject-Specific Examples (subject_box_part2 + subject_box_part4)

Run from project root:
    python ingest_m3_rag.py

Prerequisites:
    - .env with GEMINI_API_KEY
    - M3 module record exists in modules_module
    - M3 main_content + subject_box records exist in modules_modulecontent
    - documents + document_chunks tables exist (same schema as M1/M2/M6/M7/M12)
"""
...
# ======================================================================
# HELPERS — identical to M6 ingest
# ======================================================================
...
# ======================================================================
# M3-SPECIFIC PROCESSING FUNCTIONS
# ======================================================================
...
def main():
    print("\n" + "="*70)
    print("M3 RAG INGEST — AI Tools for Educators: Understand, Evaluate & Curate")
    print("="*70)
    ...
    try:
        ...
        row = cursor.fetchone()
        if not row:
            print("ERROR: M3 module record not found in modules_module!")
            print("Run the M3 TAB2 SQL insert first.")
            conn.close()
            return
        ...
        print("M3 content in modules_modulecontent:")
        ...
        if process_module_content(
            conn,
            'M3',
            'M3: AI Tools for Educators - Main Content'
        ):
            success_count += 1
        ...
        if process_module_subject_examples(
            conn,
            'M3',
            'M3: AI Tools for Educators - Subject Examples'
        ):
            success_count += 1
        ...
        print("\n" + "="*70)
        print("M3 INGEST COMPLETE")
        print("="*70)
        print(f"Successful: {success_count}/2")
        print()
        print("M3 documents ingested:")
        ...
        # Cost estimate
        m3_chunks = sum(c for _, c in m3_stats)
        cost = (m3_chunks * 600 / 1_000_000) * 0.02
